...
const DesktopMainProjects = () => {
  ...
  return (
    <div
      className="hidden lg:flex w-full bg-no-repeat bg-cover  justify-center items-start flex-col relative md:h-[720px] md:gap-[41px] md:mb-[248px] lg:w-[1110px] lg:px-[190px]"
